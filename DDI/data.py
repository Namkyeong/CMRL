...
if __name__ == "__main__":
    ...
    df = pd.read_csv(f'data/raw/ZhangDDI_train_transductive.csv', sep=",")
    processed_data, dataset = build_dataset(df, "smiles_1", "smiles_2", "label")
    torch.save(processed_data, "./data/processed/ZhangDDI_tranductive_train.pt")

    df = pd.read_csv(f'data/raw/ZhangDDI_train_transductive.csv', sep=",")
    processed_data, dataset = build_dataset(df, "smiles_1", "smiles_2", "label")
    torch.save(processed_data, "./data/processed/ZhangDDI_tranductive_valid.pt")

    df = pd.read_csv(f'data/raw/ZhangDDI_train_transductive.csv', sep=",")
    processed_data, dataset = build_dataset(df, "smiles_1", "smiles_2", "label")
    torch.save(processed_data, "./data/processed/ZhangDDI_tranductive_test.pt")
